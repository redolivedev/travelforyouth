 ...
 *
 * @wordpress-plugin
 * Plugin Name: Spreadsheet Integration – Connect WordPress, WooCommerce & Most popular Form Plugins With  Google Sheets. professional
...
if ( function_exists( 'wpgsi_fs' ) ) {
    wpgsi_fs()->set_basename( true, __FILE__ );
} else {
