<div class="wrap">
	...
	<h1> <?php esc_attr_e( "Google Spreadsheet Settings ", "wpgsi" ); ?> </h1>
        ...
        <form name="woogs_settings" method="POST" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" > 
            ...
            <?php if ( isset($credential['client_email'] ) ): ?>
                ...
                <?php
                    ...
                    $ret = $this->googleSheet->wpgsi_token_validation_checker( $google_token );                                                 #  Checking token is valid || Display it 
                    if ( $ret[0] ) {
