...
if(!empty($background_image)) {
    ...
    $image_bg_markup = '<div class="column-image-bg-wrap" '.$parallax_bg_attr.'data-bg-pos="'.esc_attr($background_image_position).'" data-bg-animation="'.esc_attr($bg_image_animation).'"><div class="inner-wrap">';
...
$column_link_html     = (!empty($column_link)) ? '<a class="column-link" target="'.$column_link_target.'" href="'.esc_attr($column_link).'">'.$column_link_sr_text.'</a>' : null;
$column_bg_color_html = (!empty($column_link)) ? '<a class="column-link" target="'.$column_link_target.'" href="'.esc_attr($column_link).'"></a>' : null;
